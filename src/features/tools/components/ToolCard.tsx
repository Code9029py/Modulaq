  ...
  return (
    <article className="group flex h-full flex-col rounded-xl border border-surface-200/80 bg-gradient-to-br from-surface-50/95 to-surface-100/60 p-5 shadow-sm ring-1 ring-surface-50/70 transition hover:-translate-y-0.5 hover:border-accent-cyan/40 hover:from-surface-50 hover:to-surface-50/90 hover:shadow-soft">
      ...
      <div className="mt-5 border-t border-surface-200/80 pt-4">
        <Link
          className="inline-flex min-h-10 items-center justify-center rounded-md bg-ink-900 px-4 py-2 text-sm font-semibold text-surface-50 shadow-panel transition hover:-translate-y-0.5 hover:bg-ink-700 hover:shadow-soft focus:outline-none focus:ring-2 focus:ring-accent-cyan/25"
